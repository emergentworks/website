...
const TeamPage = () => {
  ...
  return (
    <Layout>
      <SEO title="Team" />
      <section className="gridContainer12">
        <h1 className={cx('title', 'content-max-width')}>
          We are the Emergent Works Family.
        </h1>
        <div>
          <p>
            We believe that developing software and educational programming that
            is responsive to the problems our clients and society face,
            necessitates that our team be representative of the diverse range of
            perspectives in the world. Having team members with direct lived
            experience with the problems we solve for our clients and
      ...
      <section className={cx(styles.gridContainer12)}>
