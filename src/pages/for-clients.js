...
import ImgShowcase from '_assets/images/showcase-2020-1.jpg'
  ...
  <Layout className={styles.page}>
    ...
    <div className={cx(styles.root, 'content')}>
        ...
        <GridItem>
          <section className={styles.servicesGroup}>
            ...
            <div className={styles.servicesItem}>
              ...
              <p>
                Experienced product leads guarantee that teams not only delivery
                the technology you want, but the business outcomes you need.
              </p>
            </div>
            <div className={styles.servicesItem}>
              ...
              <p>
                ...
                valuable, paid work experience to kickstart their careers in
                tech.
              </p>
            </div>
          </section>
      ...
      <section className={styles.contactUs}>
        <p className="h2">
          Let’s work together. Whether you have a project in mind, or need help
          defining it, we'd love to collaborate with you.
        </p>
        <p className="h2">
          Contact us at{' '}
