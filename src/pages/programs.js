      ...
      <div className="twoColumnLayout">
        ...
        >
          ...
          <p className="content-max-width">
            ...
            implement a software development project under the guidance of, and
            in collaboration with, their mentors. During the culminating
            showcase event of the program, pairs present their completed
            projects to the EW community. The EW mentorship program serves as a
            gateway to careers in software engineering by providing our
            community members with access and exposure to a supportive community
            of learners, professionals, educational resources, and a
        ...
        >
          ...
          <p className="content-max-width">
            A 16-week program that introduces artists from communities impacted
            by incarceration to technology through therapeutic writing
            practices, music/video production, and audio engineering. The
            program provides participants with a fundamental working-knowledge
            of DAW's, music production, and song writing. TRAP teaches
            participants the requisite web development skills to build a web
            page that showcases the skills they gain recording with professional
            audio engineers and learning the practices of therapeutic
            songwriting. The program culminates with participants
      ...
      <div className="twoColumnLayout">
        ...
        >
          ...
          <p className="content-max-width">
            ...
            leadership-development program as they work full-time on our
            software products team. Participants learn skills essential for
            senior leadership in the modern tech workforce including project and
            personnel management. As a result, they complete the program with
            the background necessary to rapidly advance to mid and senior levels
            in their career in the months and years after completion.
          </p>
        </section>
