...
const IndexPage = () => {
  const data = useStaticQuery(graphql`
    query {
      sponsorNames: file(relativePath: { eq: "sponsorNames.png" }) {
        childImageSharp {
          fluid(maxWidth: 800) {
  ...
  return (
    <Layout className={styles.page}>
      ...
      <section className={'content'}>
        ...
        <iframe src="https://player.vimeo.com/video/335249244?autoplay=1&title=0&byline=0&portrait=0" style={{position:"absolute", top:0, left:0, width:"100%", height:"100%"}} frameBorder="0" allow="autoplay; fullscreen" allowFullScreen></iframe>
      ...
      <h3 className={styles.sponsorNames}>
        <Img
          fluid={data.sponsorNames.childImageSharp.fluid}
