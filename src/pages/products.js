      ...
      <div className="twoColumnLayout">
        ...
        >
          ...
          <p className="content-max-width">
            ...
            police involvement. Not911 connects users to nonprofits and
            government agencies to address issues ranging from domestic violence
            to homelessness, without police intervention.
          </p>
        </section>
      </div>
      <div className="twoColumnLayout">
