      ...
      <section className="page-content">
        ...
        <ul>
          <li>
            ...
            internships. Your organization can be a stepping stone for talented
            individuals ready to contribute their skills and creativity.
          </li>
          <li>
            <span className="fwb">Foster Community Growth</span>: Host community
            sessions to share your expertise and provide valuable insights. Your
            involvement can inspire and guide our members, helping them navigate
